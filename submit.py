...
def main():
    ...
    check_and_mkdirs(output_dir + "_qa")
    check_and_mkdirs(output_dir + "_answer")
  ...
  --data-dir={output_dir}_qa \
  --hparams '{{"model_size": "large", "task_names": ["squad"], "eval_batch_size": 16, "predict_batch_size": 16, "max_seq_length": 512, "learning_rate": 5e-5, "use_tfrecords_if_existing": false, "do_train": false, "do_eval": true, "pretrained_model_dir": {qa_model_dir} }}'
"""
    os.system(qa_xargs)

    answer_xargs = f"""python run_finetuning.py \
  --data-dir={output_dir}_answer \
  --hparams '{{"model_size": "large", "task_names": ["squad"], "eval_batch_size": 16, "predict_batch_size": 16, "max_seq_length": 512, "learning_rate": 5e-5, "use_tfrecords_if_existing": false, "do_train": false, "do_eval": true, "pretrained_model_dir": {qa_model_dir} }}'
"""
